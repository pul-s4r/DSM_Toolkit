...
Cluster_param.max_cluster_size=	16;	% max size of cluster (DSM size)
Cluster_param.rand_accept		=	32;	% proceed w/ 1 of N changes even if no imp. (0.5-2 *DSM)
Cluster_param.rand_bid			=	32;	% take second highest bid 1 out of N times (0.5-2 * DSM)
