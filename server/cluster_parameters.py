"""
    ClusterParameters defines the behaviour of Thebeau's algorithm. 
"""
...
class ClusterParameters(object):
    ...
    """
    def __init__(self, pow_cc, pow_bid, pow_dep, max_cluster_size, rand_accept,
        rand_bid, times, stable_limit, max_repeat):
